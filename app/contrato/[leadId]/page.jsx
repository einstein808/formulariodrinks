  ...
  const getFinancials = () => {
    ...
    if (isTier) {
      ...
      return {
        ...
        valor_por_convidado: convidadosInformados > 0 ? Math.ceil(calc.basePrice / convidadosInformados) : 0,
        valor_por_convidado_formatado: convidadosInformados > 0 ? formatBRL(Math.ceil(calc.basePrice / convidadosInformados)) : '0,00',
