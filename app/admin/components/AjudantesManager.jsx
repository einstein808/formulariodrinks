...
import { FiPlus, FiTrash2, FiUser, FiPhone, FiBriefcase } from 'react-icons/fi';
...
export default function AjudantesManager() {
  ...
  const handleDelete = async (slug, nome) => {
    if (!window.confirm(`Excluir ajudante "${nome}"? Os eventos passados onde ele foi vinculado manterão seu registro.`)) return;
    try {
